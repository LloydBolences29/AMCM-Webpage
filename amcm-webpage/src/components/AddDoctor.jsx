        ...
        <Col md={8} lg={6}>
          <Card className="shadow-lg border-0">
            ...
            <Card.Body className="p-4">
              ...
              <div className="mb-4">
                <Badge className="mb-2" style={{ backgroundColor: "#163235" }}>Instructions</Badge>
                <p className="text-muted small">
                  Please fill in all the required information to add a new doctor to the system. 
      ...
      <Form onSubmit={handleSubmit}>
          ...
          <Col md={12}>
            <Form.Group className="mb-3">
              <Form.Label className="fw-bold">
                <i className="fas fa-user me-2"></i>Doctor's Name
              </Form.Label>
              <Form.Control
                type="text"
        ...
        <Row>
          <Col md={6}>
            <Form.Group className="mb-3">
              <Form.Label className="fw-bold">
                <i className="fas fa-door-open me-2"></i>Room Number
              </Form.Label>
              <Form.Control
                type="text"
          ...
          <Col md={6}>
            <Form.Group className="mb-3">
              <Form.Label className="fw-bold">
                <i className="fas fa-phone me-2"></i>Local Phone
              </Form.Label>
              <Form.Control
                type="text"
